...
describe('Testing authentication GET and POST /api/crypto/btc', () => {
  ...
  it('GET /api/crypto/btc should return json { message: "Token inválido" } when not authenticated', () => frisby.get(`${URL}api/crypto/btc`)
    .expect('json', { message: 'Token inválido' }));

  it('POST /api/crypto/btc should return json { message: "Token inválido" } when not authenticated', () => frisby.post(`${URL}api/crypto/btc`)
    .expect('json', { message: 'Token inválido' }));
});
